#!/usr/bin/env python3
"""Story 14.11 — Add Governing Law, Jurisdiction & Venue translations to all 10 locale files."""
import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = json.loads((ROOT / "scripts" / "story14_11_data.json").read_text("utf-8"))
...
print("Done — Story 14.11 translations added.")
