#!/usr/bin/env python3
"""Inject Story 7.1 (DSA Transparency) translations."""

import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = ROOT / "scripts" / "story7_1_data.json"
...
for key, fname in LOCALE_MAP.items():
    ...
    terms["dsaCompliance"] = data[key]["dsaCompliance"]
    fp.write_text(json.dumps(obj, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(f"Updated {fname}")

print("Done — Story 7.1 translations added.")
