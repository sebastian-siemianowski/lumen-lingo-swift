#!/usr/bin/env python3
"""Story 14.15 — Add Pre-Suit Notice & Mandatory Negotiation translations to all 10 locale files."""
import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = json.loads((ROOT / "scripts" / "story14_15_data.json").read_text("utf-8"))
...
print("Done — Story 14.15 translations added.")
