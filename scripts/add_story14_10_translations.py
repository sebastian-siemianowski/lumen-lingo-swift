#!/usr/bin/env python3
"""Story 14.10 — Add Refund & Cancellation Policy translations to all 10 locale files."""
import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = json.loads((ROOT / "scripts" / "story14_10_data.json").read_text("utf-8"))
...
print("Done — Story 14.10 translations added.")
