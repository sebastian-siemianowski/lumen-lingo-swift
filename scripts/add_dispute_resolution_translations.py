...
TRANSLATIONS = {
    "en": {
        "disputeResolution": {
            ...
            "step1P1": "Before initiating any formal proceedings, please contact us at <emailLink>hello@lumenshore.com</emailLink> with a detailed description of your concern. We commit to engaging in good faith discussions to resolve the matter within <b>30 days</b> of receiving your communication.",
            ...
            "odrP1": "If you are a consumer in the European Union, you may also use the European Commission's Online Dispute Resolution (ODR) platform to resolve disputes: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. Our email for ODR purposes is hello@lumenshore.com.",
            ...
            "arbitrationP2": "You have the right to <b>opt out</b> of this arbitration clause within 30 days of first accepting these Terms by sending written notice to hello@lumenshore.com. If you opt out, disputes will be resolved in the courts of England and Wales.",
    ...
    "es": {
        "disputeResolution": {
            ...
            "odrP1": "Si usted es un consumidor en la Union Europea, tambien puede utilizar la plataforma de Resolucion de Disputas en Linea (ODR) de la Comision Europea para resolver disputas: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. Nuestro correo electronico para fines de ODR es hello@lumenshore.com.",
            ...
            "arbitrationP2": "Tiene derecho a <b>excluirse</b> de esta clausula de arbitraje dentro de los 30 dias posteriores a la primera aceptacion de estos Terminos enviando un aviso por escrito a hello@lumenshore.com. Si se excluye, las disputas se resolveran ante los tribunales de Inglaterra y Gales.",
    ...
    "fr": {
        "disputeResolution": {
            ...
            "odrP1": "Si vous etes un consommateur dans l'Union europeenne, vous pouvez egalement utiliser la plateforme de reglement en ligne des litiges (RLL) de la Commission europeenne : <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. Notre adresse e-mail aux fins du RLL est hello@lumenshore.com.",
            ...
            "arbitrationP2": "Vous avez le droit de vous <b>desengager</b> de cette clause d'arbitrage dans les 30 jours suivant la premiere acceptation de ces Conditions en envoyant un avis ecrit a hello@lumenshore.com. Si vous vous desengagez, les litiges seront resolus devant les tribunaux d'Angleterre et du pays de Galles.",
    ...
    "de": {
        "disputeResolution": {
            ...
            "step1P1": "Bevor Sie formelle Verfahren einleiten, kontaktieren Sie uns bitte unter <emailLink>hello@lumenshore.com</emailLink> mit einer detaillierten Beschreibung Ihres Anliegens. Wir verpflichten uns, innerhalb von <b>30 Tagen</b> nach Erhalt Ihrer Mitteilung in gutem Glauben Gespraeche zur Loesung des Problems zu fuehren.",
            ...
            "odrP1": "Wenn Sie ein Verbraucher in der Europaeischen Union sind, koennen Sie auch die Online-Streitbeilegungs-Plattform (OS) der Europaeischen Kommission nutzen: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. Unsere E-Mail-Adresse fuer OS-Zwecke ist hello@lumenshore.com.",
            ...
            "arbitrationP2": "Sie haben das Recht, sich innerhalb von 30 Tagen nach der ersten Annahme dieser Bedingungen von dieser Schiedsklausel <b>abzumelden</b>, indem Sie eine schriftliche Mitteilung an hello@lumenshore.com senden. Wenn Sie sich abmelden, werden Streitigkeiten vor den Gerichten von England und Wales geloest.",
    ...
    "ja": {
        "disputeResolution": {
            ...
            "step1P1": "正式な手続きを開始する前に、お客様の懸念事項の詳細な説明とともに<emailLink>hello@lumenshore.com</emailLink>までご連絡ください。お客様のご連絡を受領してから<b>30日以内</b>に誠意をもって問題解決のための協議を行うことをお約束します。",
            ...
            "odrP1": "欧州連合の消費者の方は、欧州委員会のオンライン紛争解決（ODR）プラットフォームもご利用いただけます：<odrLink>https://ec.europa.eu/consumers/odr/</odrLink>。ODR目的の当社メールアドレスはhello@lumenshore.comです。",
            ...
            "arbitrationP2": "本規約を最初に承諾してから30日以内にhello@lumenshore.comに書面による通知を送付することにより、この仲裁条項から<b>オプトアウト</b>する権利があります。オプトアウトした場合、紛争はイングランドおよびウェールズの裁判所で解決されます。",
    ...
    "pt": {
        "disputeResolution": {
            ...
            "step1P1": "Antes de iniciar qualquer procedimento formal, entre em contato conosco em <emailLink>hello@lumenshore.com</emailLink> com uma descricao detalhada da sua preocupacao. Comprometemo-nos a participar de discussoes de boa-fe para resolver a questao dentro de <b>30 dias</b> apos o recebimento da sua comunicacao.",
            ...
            "odrP1": "Se voce e um consumidor na Uniao Europeia, tambem pode utilizar a plataforma de Resolucao de Litigios em Linha (RLL) da Comissao Europeia: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. O nosso e-mail para efeitos de RLL e hello@lumenshore.com.",
            ...
            "arbitrationP2": "Voce tem o direito de <b>optar por nao participar</b> desta clausula de arbitragem dentro de 30 dias apos a primeira aceitacao destes Termos, enviando uma notificacao por escrito para hello@lumenshore.com. Se optar por nao participar, as disputas serao resolvidas nos tribunais da Inglaterra e do Pais de Gales.",
    ...
    "pl": {
        "disputeResolution": {
            ...
            "step1P1": "Przed wszczeciem jakichkolwiek formalnych postępowan prosimy o kontakt pod adresem <emailLink>hello@lumenshore.com</emailLink> ze szczegolowym opisem problemu. Zobowiazujemy sie do prowadzenia rozmow w dobrej wierze w celu rozwiazania sprawy w ciagu <b>30 dni</b> od otrzymania Twojej wiadomosci.",
            ...
            "odrP1": "Jezeli jestes konsumentem w Unii Europejskiej, mozesz rowniez skorzystac z platformy internetowego rozwiazywania sporow (ODR) Komisji Europejskiej: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. Nasz adres e-mail do celow ODR to hello@lumenshore.com.",
            ...
            "arbitrationP2": "Masz prawo <b>zrezygnowac</b> z niniejszej klauzuli arbitrazowej w ciagu 30 dni od pierwszego zaakceptowania niniejszych Warunkow, wysylajac pisemne powiadomienie na adres hello@lumenshore.com. Jezeli zrezygnujesz, spory beda rozwiazywane przed sadami Anglii i Walii.",
    ...
    "ar": {
        "disputeResolution": {
            ...
            "step1P1": "قبل بدء أي إجراءات رسمية، يرجى التواصل معنا على <emailLink>hello@lumenshore.com</emailLink> مع وصف تفصيلي لمخاوفك. نلتزم بالمشاركة في مناقشات بحسن نية لحل المسألة خلال <b>30 يومًا</b> من تلقي اتصالك.",
            ...
            "odrP1": "إذا كنت مستهلكًا في الاتحاد الأوروبي، يمكنك أيضًا استخدام منصة حل النزاعات عبر الإنترنت (ODR) التابعة للمفوضية الأوروبية: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. بريدنا الإلكتروني لأغراض ODR هو hello@lumenshore.com.",
            ...
            "arbitrationP2": "لديك الحق في <b>الانسحاب</b> من شرط التحكيم هذا خلال 30 يومًا من أول قبول لهذه الشروط عن طريق إرسال إشعار كتابي إلى hello@lumenshore.com. عند الانسحاب، سيتم حل النزاعات في محاكم إنجلترا وويلز.",
    ...
    "zh": {
        "disputeResolution": {
            ...
            "step1P1": "在发起任何正式程序之前，请通过<emailLink>hello@lumenshore.com</emailLink>与我们联系，详细描述您的问题。我们承诺在收到您的来信后<b>30天内</b>本着善意进行讨论以解决问题。",
            "step2Heading": "第二步 — 调解",
            ...
            "odrHeading": "欧盟在线争议解决",
            "odrP1": "如果您是欧盟的消费者，您还可以使用欧盟委员会的在线争议解决（ODR）平台：<odrLink>https://ec.europa.eu/consumers/odr/</odrLink>。我们用于ODR目的的电子邮件是hello@lumenshore.com。",
            ...
            "arbitrationP2": "您有权在首次接受本条款后30天内通过向hello@lumenshore.com发送书面通知来<b>选择退出</b>本仲裁条款。如果您选择退出，争议将在英格兰和威尔士法院解决。",
    ...
    "uk": {
        "disputeResolution": {
            ...
            "step1P1": "Перш ніж розпочинати будь-які формальні процедури, будь ласка, зв'яжіться з нами за адресою <emailLink>hello@lumenshore.com</emailLink> з детальним описом вашого питання. Ми зобов'язуємось вести обговорення добросовісно для вирішення питання протягом <b>30 днів</b> з моменту отримання вашого звернення.",
            ...
            "odrP1": "Якщо ви є споживачем у Європейському Союзі, ви також можете скористатися платформою онлайн-вирішення спорів (ODR) Європейської Комісії: <odrLink>https://ec.europa.eu/consumers/odr/</odrLink>. Наша електронна адреса для цілей ODR — hello@lumenshore.com.",
            ...
            "arbitrationP2": "Ви маєте право <b>відмовитися</b> від цього арбітражного застереження протягом 30 днів з моменту першого прийняття цих Умов, надіславши письмове повідомлення на hello@lumenshore.com. Якщо ви відмовитесь, спори будуть вирішуватися в судах Англії та Уельсу.",
