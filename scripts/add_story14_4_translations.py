...
TRANSLATIONS = {
    "en": {
        "usArbitration": {
            ...
            "optOutP1": "You may opt out of this arbitration agreement within 30 days of first accepting these Terms by sending written notice to <emailLink>hello@lumenshore.com</emailLink>. If you opt out, you retain all other rights under these Terms.",
    ...
    "es": {
        "usArbitration": {
            ...
            "optOutP1": "Puede optar por no participar en este acuerdo de arbitraje dentro de los 30 dias posteriores a la primera aceptacion de estos Terminos enviando un aviso por escrito a <emailLink>hello@lumenshore.com</emailLink>. Si opta por no participar, conserva todos los demas derechos en virtud de estos Terminos.",
    ...
    "fr": {
        "usArbitration": {
            ...
            "optOutP1": "Vous pouvez vous retirer de cet accord d'arbitrage dans les 30 jours suivant la premiere acceptation des presentes Conditions en envoyant un avis ecrit a <emailLink>hello@lumenshore.com</emailLink>.",
    ...
    "de": {
        "usArbitration": {
            ...
            "optOutP1": "Sie koennen innerhalb von 30 Tagen nach erstmaliger Annahme dieser Bedingungen von dieser Schiedsvereinbarung zuruecktreten, indem Sie eine schriftliche Mitteilung an <emailLink>hello@lumenshore.com</emailLink> senden.",
    ...
    "ja": {
        "usArbitration": {
            ...
            "optOutP1": "<emailLink>hello@lumenshore.com</emailLink>に書面で通知を送ることにより、本規約を最初に承諾してから30日以内にこの仲裁合意からオプトアウトできます。",
    ...
    "pt": {
        "usArbitration": {
            ...
            "optOutP1": "Voce pode optar por nao participar deste acordo de arbitragem dentro de 30 dias apos a primeira aceitacao destes Termos, enviando aviso por escrito para <emailLink>hello@lumenshore.com</emailLink>.",
    ...
    "pl": {
        "usArbitration": {
            ...
            "optOutP1": "Mozesz zrezygnowac z tej umowy arbitrazowej w ciagu 30 dni od pierwszego zaakceptowania niniejszych Warunkow, wysylajac pisemne zawiadomienie na adres <emailLink>hello@lumenshore.com</emailLink>.",
    ...
    "ar": {
        "usArbitration": {
            ...
            "optOutP1": "يمكنك الانسحاب من اتفاقية التحكيم هذه خلال 30 يومًا من قبول هذه الشروط لأول مرة عن طريق إرسال إشعار كتابي إلى <emailLink>hello@lumenshore.com</emailLink>.",
    ...
    "zh": {
        "usArbitration": {
            ...
            "optOutP1": "您可以在首次接受本条款后30天内向<emailLink>hello@lumenshore.com</emailLink>发送书面通知，退出本仲裁协议。",
    ...
    "uk": {
        "usArbitration": {
            ...
            "optOutP1": "Ви можете відмовитися від цієї арбітражної угоди протягом 30 днів після першого прийняття цих Умов, надіславши письмове повідомлення на <emailLink>hello@lumenshore.com</emailLink>.",
