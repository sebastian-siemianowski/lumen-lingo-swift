#!/usr/bin/env python3
"""Inject Story 14.20 (Account Security & Single-User License) translations."""

import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = ROOT / "scripts" / "story14_20_data.json"
...
for key, fname in LOCALE_MAP.items():
    ...
    terms["accountSecurity"] = data[key]["accountSecurity"]
    fp.write_text(json.dumps(obj, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(f"Updated {fname}")

print("Done — Story 14.20 translations added.")
