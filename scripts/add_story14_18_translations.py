#!/usr/bin/env python3
"""Inject Story 14.18 (Service Discontinuation, Business Transfer & Wind-Down) translations."""

import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = ROOT / "scripts" / "story14_18_data.json"
...
for key, fname in LOCALE_MAP.items():
    ...
    terms["serviceDiscontinuation"] = data[key]["serviceDiscontinuation"]
    fp.write_text(json.dumps(obj, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(f"Updated {fname}")

print("Done — Story 14.18 translations added.")
