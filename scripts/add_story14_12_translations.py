#!/usr/bin/env python3
"""Story 14.12 — Add Assumption of Risk & Release translations to all 10 locale files."""
import json, pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
DATA = json.loads((ROOT / "scripts" / "story14_12_data.json").read_text("utf-8"))
...
print("Done — Story 14.12 translations added.")
