...
### english_arabic — ✅ COMPLETE (105/105 categories, 1575 items)
...
| 21 | sentence_parsing_i3rab, cultural_expressions | ✅ |

### english_chinese — ✅ COMPLETE (105/105 categories, 1575 items)
ID prefixes used: ec_wo, ec_mw, ec_time, ec_asp, ec_q, ec_n, ec_c, ec_sp, ec_de, ec_pr, ec_pb, ec_nc, ec_cl, ec_mv, ec_loc, ec_cj, ec_pos, ec_dm, ec_gr, ec_cs, ec_ft, ec_dr, ec_ba, ec_bei, ec_rc, ec_dc, ec_deg, ec_pot, ec_dur, ec_freq, ec_ex, ec_sv, ec_piv, ec_tc, ec_sd, ec_le, ec_zhe, ec_guo, ec_cov, ec_woa, ec_rcl, ec_ech, ec_voc, ec_drc, ec_pur, ec_cef, ec_rsp, ec_cmpa, ec_exc, ec_imp, ec_bvm, ec_jvc, ec_sfp, ec_rsc, ec_obl, ec_abl, ec_wsh, ec_nea, ec_idp, ec_chy, ec_exp, ec_sug, ec_tca, ec_sep, ec_nmp, ec_apx, ec_cnt, ec_adr, ec_plt, ec_fwc, ec_qty, ec_mnr, ec_sim, ec_seq, ec_inc, ec_con, ec_prp, ec_pav, ec_red, ec_rhq, ec_dbn, ec_ccj, ec_cpa, ec_edg, ec_ecd, ec_ect, ec_eem, ec_dsm, ec_frg, ec_idi, ec_pvs, ec_wth, ec_fod, ec_trv, ec_hlb, ec_wrk, ec_tci, ec_edu, ec_sph, ec_shp, ec_hh, ec_env, ec_mdc, ec_art, ec_err
...
| 20 | media_communication, arts_culture, common_errors | ✅ |
...
### english_german — ✅ COMPLETE (105/105 categories, 1575 items)
All 20 batches completed. ID prefixes used: eg_pres, eg_art, eg_past, eg_order, eg_case, eg_prep, eg_mod, eg_pp, eg_plq, eg_fut, eg_acc, eg_dat, eg_gen, eg_plu, eg_adj, eg_sep, eg_ref, eg_conj, eg_sub, eg_rel, eg_pv, eg_imp, eg_cmp, eg_sup, eg_adv, eg_neg, eg_qf, eg_pos, eg_dem, eg_ind, eg_per, eg_twp, eg_tp, eg_vp, eg_kii, eg_ki, eg_cond, eg_rs, eg_inf, eg_ptc, eg_ng, eg_cn, eg_wn, eg_sv, eg_mx, eg_hvs, eg_wu, eg_da, eg_wo, eg_di, eg_fp, eg_sw, eg_eo, eg_ms, eg_fi, eg_id, eg_ps, eg_te, eg_nq, eg_dm, eg_wf, eg_pf, eg_vpc, eg_apc, eg_npc, eg_es, eg_pov, eg_las, eg_mp, eg_disc, eg_lw, eg_emph, eg_wc, eg_rest, eg_shop, eg_tel, eg_fw, eg_work, eg_emot, eg_trav, eg_hlth, eg_edu, eg_tech, eg_env, eg_spo, eg_fam, eg_hous, eg_trans, eg_med, eg_crim, eg_pol, eg_sci, eg_art2, eg_biz, eg_reg, eg_acad, eg_coll, eg_ff, eg_ce, eg_pa, eg_ea, eg_vpt, eg_exam, eg_awo, eg_rev
...
### japanese_english — ✅ COMPLETE (105/105 categories, 1575 items)
ID prefixes used: je_art, je_subj, je_pres, je_past, je_fut, je_mod, je_pp, je_pcon, je_paco, je_ppc, je_ppf, je_czf, je_cst, je_pv, je_rs, je_rc, je_cos, je_prpl, je_prt, je_gi, je_pvb, je_qt, je_sva, je_qn, je_det, je_cj, je_af, je_am, je_cu, je_pos, je_rp, je_ip, je_dem, je_pva, je_col, je_wo, je_cle, je_inv, je_wh, je_ut, je_hb, je_bst, je_cau, je_ptc, je_nc, je_ell, je_sub, je_emp, je_dm, je_lw, je_hdg, je_fr, je_ifr, je_aw, je_eo, je_ms, je_ad, je_ro, je_ca, je_dt, je_dp, je_cef, je_cc, je_te, je_ffa, je_nt, je_mc, je_arta, je_cn, je_ao, je_gu, je_im, je_pi, je_ff, je_cej, je_ie, je_prv, je_tv, je_fdr, je_hlb, je_wof, je_ti, je_en, je_edl, je_sh, je_fe, je_wc, je_sm, je_hh, je_td, je_mcom, je_cj2
...
### ukrainian_english — ✅ COMPLETE (105/105 categories, 1575 items)
ID prefixes used: ue_ps, ue_art, ue_past, ue_fut, ue_q, ue_cm, ue_pp, ue_pc, ue_mv, ue_ppc, ue_paco, ue_ppf, ue_czf, ue_cst, ue_pv, ue_rs, ue_rc, ue_cs, ue_pb, ue_pa, ue_gi, ue_pvb, ue_qt, ue_sva, ue_qn, ue_det, ue_cj, ue_af, ue_am, ue_cu, ue_pos, ue_rp, ue_ip, ue_dem, ue_pva, ue_pva_col, ue_col, ue_wo, ue_cle, ue_inv, ue_wh, ue_ut, ue_wr, ue_hb, ue_bst, ue_cau, ue_ptc, ue_nc, ue_ell, ue_sub, ue_emp, ue_dm, ue_lw, ue_hdg, ue_fr, ue_ifr, ue_aw, ue_eo, ue_ms, ue_ad, ue_ro, ue_ca, ue_dt, ue_dp, ue_cef, ue_cc, ue_te, ue_ffa, ue_nt, ue_mc, ue_arta, ue_cn, ue_ao, ue_gu, ue_im, ue_pi, ue_gn, ue_ff, ue_ie, ue_prv, ue_tv, ue_fdr, ue_hb2_, ue_wof, ue_ti, ue_en, ue_edl, ue_sh, ue_fe, ue_wc, ue_sm, ue_hh, ue_td, ue_mcom, ue_cj2, ue_pso, ue_sr, ue_ac, ue_be, ue_rsa, ue_pva2, ue_rca, ue_ef, ue_es, ue_nm, ue_exs
...
### japanese_english (Flashcards) — ✅ COMPLETE
Front language: Japanese, Back language: English. Target: 100 categories, 1500 items. **DONE: 100 categories, 1500 items.**
...
### polish_arabic (Flashcards) — ✅ COMPLETE
Front language: Polish, Back language: Arabic. Target: 100 categories, 1500 items. **DONE: 100 categories, 1500 items.**
...
### polish_french (Flashcards) — ✅ COMPLETE
Front language: Polish, Back language: French. Target: 100 categories, 1500 items. **DONE: 100 categories, 1500 items.**
...
| 12 | phone_communication, religion_spirituality, problems_solutions, describing_people, apartment_living | ✅ |
| 13 | personality_traits, learning_education, tools_diy, documents_forms, safety_emergencies | ✅ |
| 14 | banking_services, nature_environment, internet_social_media, professions_advanced, ideas_inventions | ✅ |
| 15 | opinions_beliefs, work_business, energy_power, social_gatherings, materials_substances | ✅ |
| 16 | special_occasions, french_culture, law_justice, daily_expressions | ✅ |

---

### polish_chinese (Flashcards) — ✅ COMPLETE
Front language: Polish, Back language: Chinese. Target: 100 categories, 1500 items. ✅ DONE
...
| 12 | phone_communication, religion_spirituality, problems_solutions, describing_people, apartment_living | ✅ |
| 13 | personality_traits, learning_education, tools_diy, documents_forms, safety_emergencies | ✅ |
| 14 | banking_services, nature_environment, internet_social, professions_advanced, ideas_opinions | ✅ |
| 15 | work_office_advanced, energy_power, social_gatherings, materials_substances, chinese_food_culture | ✅ |
| 16 | special_occasions, personality_character, chinese_history, daily_expressions | ✅ |
...
### ukrainian_english (Flashcards) — ✅ COMPLETE (100/100 categories, 1500 items)
...
### ukrainian_polish (Flashcards) — ✅ COMPLETE
Front language: Ukrainian, Back language: Polish. **100 categories, 1500 items.**
...
| 14 | internet_social, law_justice, media_news, architecture_buildings, space_astronomy | ✅ |
| 15 | energy_power, social_gatherings, materials_substances, special_occasions, personality_character | ✅ |
| 16 | opinions_thoughts, polish_culture, common_mistakes, advanced_education, fairy_tales_stories | ✅ |
