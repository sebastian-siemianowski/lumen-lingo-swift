...
export default function LanguageSelectionDesktop({ data }) {
  ...
  return (
    <div className="hidden lg:block relative">
      ...
      <div className={`relative rounded-[18px] sm:rounded-[24px] border p-4 transition-all duration-500 ${
        darkMode
      ...
      >
        <LanguageSelectionHeader selectedSource={selectedSource} t={t} />

        <div className="relative grid grid-cols-2 gap-3">
          {/* Subtle glowing vertical divider between panels */}
          <div 
            className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-[3px] rounded-full blur-sm pointer-events-none"
            style={{
              background: darkMode ? 'rgba(168, 85, 247, 0.15)' : 'rgba(255, 255, 255, 0.08)'
            }}
          />
        ...
        <div className="mt-4">
          {error && (
            <motion.div 
              ...
              className={`mb-3 p-2.5 rounded-[18px] sm:rounded-[24px] flex items-center justify-center gap-2 ${
