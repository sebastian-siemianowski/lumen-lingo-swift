...
export default function FlashCardsCategoriesContainer() {
  ...
  } = useCategoryData('flashcards', sourceLanguage, targetLanguage);

  const handleSelectCategory = (categoryKey) => {
    navigate(createPageUrl("FlashCards") + `?category=${categoryKey}`);
  };
  ...
  return (
    ...
    >
      <CategorySelector
        gameType="flashcards"
        title={t('choose_flashcard_category')}
