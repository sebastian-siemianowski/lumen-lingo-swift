...
export default function WordBuilderCategoriesContainer() {
  ...
  } = useCategoryData('word_builder', sourceLanguage, targetLanguage);

  const handleSelectCategory = (categoryKey) => {
    navigate(createPageUrl("WordBuilder") + `?category=${categoryKey}`);
  };
