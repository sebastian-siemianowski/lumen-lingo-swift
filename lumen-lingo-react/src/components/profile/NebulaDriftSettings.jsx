...
export default function NebulaDriftSettings() {
      ...
      >
        ...
        {!darkMode && (
          <>
            ...
            <div className="absolute inset-0 pointer-events-none rounded-[18px] sm:rounded-[24px]" />
            <div className="absolute inset-0 pointer-events-none rounded-[18px] sm:rounded-[24px]" style={{ background: 'radial-gradient(900px 320px at 12% 0%, rgba(236, 72, 153, 0.16), transparent 68%), radial-gradient(900px 320px at 88% 100%, rgba(168, 85, 247, 0.14), transparent 68%)' }} />
            <div className="absolute inset-0 pointer-events-none rounded-[18px] sm:rounded-[24px]" style={{ background: 'linear-gradient(to bottom, rgba(0,0,0,0.06), transparent)' }} />
          </>
        )}
        ...
        <div className="relative z-10" style={{ isolation: 'isolate' }}>
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
              ...
              >
                <CloudFog
                  className={`w-4 h-4 sm:w-6 sm:h-6 ${darkMode ? nebulaEnabled ? 'text-violet-300' : 'text-purple-300/60' : 'text-white'}`}
          ...
          <Collapse isOpen={true} noAnimation={true}>
            <div className="overflow-hidden" style={{ contain: 'layout paint' }}>
              <div className={`space-y-5 sm:space-y-6 ${!darkMode ? 'pointer-events-none opacity-50' : ''}`}>
                ...
                {/* Scene Cards Grid - Matching Quantum Flow Style */}
                <div 
                    ...
                    {NEBULA_SCENES.map(scene => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Scene Name & Description - Compact */}
