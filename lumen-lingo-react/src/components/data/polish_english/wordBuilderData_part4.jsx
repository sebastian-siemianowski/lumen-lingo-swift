/**
 * POLISH → ENGLISH WORD BUILDER - PART 4
 * Categories: 23-30
 * 8 categories, 15 words each = 120 words
 */

import { Ship, Hammer, Wrench, Paintbrush, Lightbulb, Plug, Key, DoorOpen } from "lucide-react";

export const wordBuilderCategories_part4 = {
  maritime_sailing: {
    name: "Żegluga i marynistyka",
    description: "Statki i podróże wodne",
    icon: Ship,
    color: "from-cyan-500 to-blue-600",
    level: "advanced",
    words: [
      { word: "ship", hint: "statek" },
      { word: "boat", hint: "łódź" },
      { word: "yacht", hint: "jacht" },
      { word: "harbor", hint: "port" },
      { word: "dock", hint: "dok" },
      { word: "anchor", hint: "kotwica" },
      { word: "sail", hint: "żagiel" },
      { word: "mast", hint: "maszt" },
      { word: "captain", hint: "kapitan" },
      { word: "crew", hint: "załoga" },
      { word: "deck", hint: "pokład" },
      { word: "cabin", hint: "kabina" },
      { word: "lighthouse", hint: "latarnia morska" },
      { word: "navigation", hint: "nawigacja" },
      { word: "voyage", hint: "rejs" }
    ]
  },
