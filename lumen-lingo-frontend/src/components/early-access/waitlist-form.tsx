        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="h-12 w-full rounded-[--radius-button] border border-glass-border bg-white/5 px-4 text-sm text-foreground placeholder:text-foreground-muted/60 transition-colors focus:border-violet/50 focus:outline-none focus:ring-2 focus:ring-violet/20 disabled:opacity-50"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              disabled={state === 'loading'}
              className="h-12 w-full appearance-none rounded-[--radius-button] border border-glass-border bg-white/5 px-4 text-sm text-foreground transition-colors focus:border-violet/50 focus:outline-none focus:ring-2 focus:ring-violet/20 disabled:opacity-50"
            >
