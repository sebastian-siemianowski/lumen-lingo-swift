          ...
          <nav className="flex h-14 items-center justify-between sm:h-16" aria-label={t('mainNav')}>
            ...
            <div className="hidden items-center gap-3 md:flex">
              <a
                ...
                className="inline-flex cursor-pointer items-center justify-center rounded-[--radius-sm] bg-violet-hover px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:bg-violet-active hover:shadow-[0_0_40px_rgba(139,92,246,0.4)] focus-visible:ring-2 focus-visible:ring-violet focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none glow-violet"
              >
                <svg className="me-2 h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <div className="flex h-full flex-col px-6 pt-24 pb-8">
                ...
                >
                  <a
                    ...
                    className="inline-flex w-full cursor-pointer items-center justify-center rounded-[--radius-button] bg-violet-hover px-8 py-3 text-lg font-medium text-white transition-all duration-200 hover:bg-violet-active hover:shadow-[0_0_40px_rgba(139,92,246,0.4)] focus-visible:ring-2 focus-visible:ring-violet focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none glow-violet"
                  >
