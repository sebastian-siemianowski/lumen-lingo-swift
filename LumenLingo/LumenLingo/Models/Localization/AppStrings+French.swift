...
extension AppStrings {
    static let french = AppStrings(
        ...
        exportDataDesc: "Téléchargez votre historique d'apprentissage — consultez vos progrès hors ligne, partagez avec vos tuteurs ou gardez un suivi personnel",
        exportAsCSV: "Exporter en CSV",
        exportAsJSON: "Exporter en JSON",
        exportAsPDF: "Exporter en PDF",
        exportReady: "Vos données sont prêtes à partager",
        noDataToExport: "Aucune donnée à exporter pour l'instant",
        sessionsLabel: "Sessions",
        learningInsights: "Analyses d'Apprentissage",
        insightsDesc: "Débloquez des analyses approfondies — découvrez vos horaires d'étude optimaux, la maîtrise par catégorie et prédisez votre trajectoire de fluence",
        optimalPracticeTimes: "Horaires de Pratique Optimaux",
        bestTimeToLearn: "Votre meilleur moment pour apprendre",
        categoryMastery: "Maîtrise par Catégorie",
        masteryByCategory: "Maîtrise par catégorie",
        retentionCurve: "Courbe de Rétention",
        retentionOverTime: "Rétention au fil du temps",
        fluencyTimeline: "Chronologie de Fluence",
        predictedMilestones: "Jalons prédits",
        morning: "Matin",
        afternoon: "Après-midi",
        evening: "Soir",
        night: "Nuit",
        needMoreData: "Jouez plus de sessions pour des analyses",
        upgradedExclamation: "Amélioré !",
        tierChangedExclamation: "Bienvenue !",
