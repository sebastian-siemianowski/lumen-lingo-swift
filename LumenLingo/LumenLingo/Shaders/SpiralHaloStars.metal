...
// ============================================================
// Spiral Halo Stars — orbital, smooth rotational
// Motion profile: drift=0.5, flow=0.8, driftFreq=0.5, flowFreq=0.5
// ============================================================
...
vertex StarVertexOut spiralHaloStarVertex(
    ...
    // Spiral Halo motion constants
    const float driftMul = 0.5;
    const float flowMul = 0.8;
    const float driftFreqMul = 0.5;
    const float flowFreqMul = 0.5;
