...
// ============================================================
// Lagoon Nebula Stars — gentle, drifting cloud currents
// Motion profile: drift=1.0, flow=1.0, driftFreq=1.0, flowFreq=1.0
// ============================================================
...
vertex StarVertexOut lagoonStarVertex(
    ...
    // Lagoon motion constants
    const float driftMul = 1.0;
    const float flowMul = 1.0;
    const float driftFreqMul = 1.0;
    const float flowFreqMul = 1.0;
