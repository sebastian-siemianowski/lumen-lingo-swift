...
// ============================================================
// Solar Aurora Stars — vertical shimmer, fast flicker
// Motion profile: drift=1.3, flow=0.6, driftFreq=1.5, flowFreq=1.8
// ============================================================
...
vertex StarVertexOut solarAuroraStarVertex(
    ...
    // Solar Aurora motion constants
    const float driftMul = 1.3;
    const float flowMul = 0.6;
    const float driftFreqMul = 1.5;
    const float flowFreqMul = 1.8;
