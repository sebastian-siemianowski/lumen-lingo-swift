...
// ============================================================
// Edge of Andromeda Stars — fast, sweeping parallax
// Motion profile: drift=1.6, flow=1.2, driftFreq=1.2, flowFreq=0.9
// ============================================================
...
vertex StarVertexOut andromedaStarVertex(
    ...
    // Andromeda motion constants
    const float driftMul = 1.6;
    const float flowMul = 1.2;
    const float driftFreqMul = 1.2;
    const float flowFreqMul = 0.9;
